...
@NgModule({
  ...
  imports: [CommonModule, HomeRoutingModule, AsyncComponent, CachingComponent, FromEventComponent, CombineLatestAllComponent, WithLatestFromComponent, ConcatWithComponent, SubjectComponent, BehaviourSubjectComponent],
})
